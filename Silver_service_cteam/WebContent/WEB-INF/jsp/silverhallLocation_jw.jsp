...
<body data-spy="scroll" data-target=".site-navbar-target"
	...
	<div class="site-wrap">
		...
		<div class="site-section">
			<div class="container">
				<h1 style="margin-bottom: 50px; text-align: center;">재가노인복지시설
					정보</h1>
								...
								<table class="table no-m">
									...
									<tbody>
										<c:forEach items="${silverhallList }" var="silverhall">
											<tr>
												<td nowrap><a href="welfareFacilityDetail?facilityNo=${silverhall.facilityNo}">${silverhall.facilityName}</a></td>
												...
												<td>
													<div class="progress progress-sm no-m">
														<div class="progress-bar progress-bar-success"
															...
															aria-valuemax="100" style="width: ${silverhall.serviceScore}%">
