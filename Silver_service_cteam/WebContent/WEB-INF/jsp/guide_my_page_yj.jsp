  ...
  <div class="site-wrap">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    ...
                    <li><a href="guide_my_page" class="nav-link">도우미_서비스 신청리스트</a></li>
                    <li><a href="guide_worktime" class="nav-link">출퇴근기록</a></li>
                    <li><a href="customer_hugi_list" class="nav-link">서비스 후기</a></li>
                    <li class="has-children">
                      <a href="#">More Links</a>
                      <ul class="dropdown">
	...
	<form>
		<div class='bxslider_area'>
			...
			<a href="guide_confirm" class="btn btn-primary">확인하기</a>
			  </li>
			  <li>
			  <img src="resources/images/1.jpg" />
		      <h3>고객명 : {{}}</h3>
