...
<form action="hugi_update_suc" method="post" class='wirtehugi'>
	<div class="layer" style="top: 200px;">
	<c:forEach items="${hugi_detail}" var="h">
		...
		<div class="layer_inner">
			...
			<table class="ui celled table">
				<tbody id="list">
					<tr>
						<td>이용 후기</td>
						<td><textarea name="hugi_contents" id="hugi_contents" cols="30" rows="10" >${h.hugi_contents}</textarea>
						</td>
					<tr>
						<td>별점</td>
						<td>
			...
			<div class="button_div">
				<p>
					<input type="hidden" name="hugi_no" value="${h.hugi_no}"/>   		
					<input type="hidden" name="giver_no" value="${h.giver_no}"/>   		
					<input type="hidden" name="customer_no" value="${h.customer_no}"/>   	
	 				<button type="submit" class="btn btn-primary" id="update" value="수정하기">수정하기</button>
					<a href="customer_hugi_list_yj" class="btn btn-primary">취소하기</a>
				</p>
			</div>
		</div>
		</c:forEach>
