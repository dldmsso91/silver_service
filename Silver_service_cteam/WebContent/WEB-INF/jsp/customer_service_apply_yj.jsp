			...
			<div class="layer">
				...
				<div class="layer_inner">
					...
					<table class="ui celled table" style="width: 1000px; margin: auto;">
						...
						<tr>
							<td>서비스 종류</td>
							<td><input type="radio" name="giver_type" value="간병도우미">간병도우미&nbsp;&nbsp;&nbsp;
						...
						<tr>
							<td>희망 장소</td>
							<td><input type="text" name="hope_service_place"
								style="width: 40%" value="" /></td>
						</tr>
						<tr>
							<td>예상급여</td>
							<td>일급 : <input type="text" name="hope_salary"
								style="width: 30%;" "/>원
							</td>
						</tr>
						<tr>
							<td>현재 상태</td>
							<td><input type="checkbox" name="my_condition" value="재활">재활&nbsp;&nbsp;&nbsp;
						...
						<tr>
							<td>알러지 유무</td>
							<td><input type="checkbox" name="my_allergy" value="땅콩">땅콩&nbsp;&nbsp;&nbsp;
								...
								<input type="checkbox" name="my_allergy" value="없음">없음</td>
						</tr>
						<tr>
							<td>거동여부</td>
							<td><input type='radio' name='can_walk' value='거동가능' />거동가능&nbsp;&nbsp;&nbsp;
								<input type='radio' name='can_walk' value='거동불가능' />거동불가능</td>
						</tr>

						<tr>
							<td>예약 희망 날짜</td>
							<td><input type='date' name='hope_start_date' />부터 <input
								type='date' name='hope_finish_date' />까지</td>
						</tr>
						<tr>
							<td>희망시간</td>
							<td><select name="hope_start_servicetime"
								id="hope_start_servicetime" class="select_css03">
							...
							</select>부터&nbsp;&nbsp; <select name="hope_end_servicetime"
								id="hope_end_servicetime" class="select_css03">
