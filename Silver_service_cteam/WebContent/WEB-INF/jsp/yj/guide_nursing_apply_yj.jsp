		...
		<div class="layer_inner">
			...
			<table class="ui celled table" style="width: 1000px; margin: auto;">
				...
				<tr>
					...
					<td>1차 희망지역 <select name="sido1" id="sido1"></select> <select
						name="gugun1" id="gugun1"></select> <br> 2차 희망지역 <select
						name="sido2" id="sido2"></select> <select name="gugun2"
						id="gugun2"></select>
					</td>
				</tr>
				<tr>
			...
			<div class="button_div">
				<p>
					<a href="" class="btn btn-primary">직업적성검사</a>
				</p>
				<br />
				<p>
