...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <!--  반복문으로 사용 -->
      ...
      <td> <div class="button_div">
                  <p><a href="customer_hugi_write" class="btn btn-primary">후기 쓰기</a></p>   
                  <p><a href="customer_service_apply" class="btn btn-primary">재신청</a></p></div></td>
    </tr>
         <tr>
      <td><img src="resources/images/svg/svg/001-elderly.svg" alt="Image" class="img-fluid" style="width: 250px;"></td>
      <td>
      ...
      <td>2020.12.01</td>
      <td> <div class="button_div">
                  <p><a href="custmoer_hugi_write" class="btn btn-primary">후기 쓰기</a></p>   
                  <p><a href="cutomer_service_apply" class="btn btn-primary">재신청</a></p></div></td>
    </tr>
      <tr>
      <td><img src="resources/images/svg/svg/001-elderly.svg" alt="Image" class="img-fluid" style="width: 250px;"></td>
      <td>
	...
	<form>
		<div class='bxslider_area'>
			...
			<a href="test" class="btn btn-primary">신청하기</a>
			  </li>
			  <li>
