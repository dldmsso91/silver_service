      ...
      <div class="container">
        <div class="row">
      	...
      	<div class="apply_button">
  	     	<p>
        		<a href="customer_service_apply_yj" class="btn btn-primary" id="apply_button">서비스 신청하기</a>               
    	    	<a href="guide_nursing_apply_yj" class="btn btn-primary" id="apply_button">간병인 지원하기</a>
	       	</p>               
	    </div>
      </div>
	</div>
