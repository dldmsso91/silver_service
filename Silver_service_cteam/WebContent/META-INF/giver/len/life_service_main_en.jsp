          ...
          <div class="col-6 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-3">
            <div class="service">
              ...
              <div class="service-text">
            	...
            	<p><a href="customer_service_apply_yj" class="btn btn-primary">서비스 신청하기</a></p>               
            	<p><a href="guide_Life_apply_yj" class="btn btn-primary">도우미 지원하기</a></p>               
              </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-5 ml-auto">
            <div class="section-heading">
              ...
              <p><a href="customer_service_apply_yj" class="btn btn-white">서비스 신청</a></p>
            </div>
          </div>
        </div>
      </div>
