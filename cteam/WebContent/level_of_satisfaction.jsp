      ...
      <div class="container">
        <div class="row">
          <div class="col-6 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-3">
            <div class="service">
              <a href="caregiver_service_main.do" class="d-block"><img src="resources/images/sad.png" alt="Image" class="img-fluid"></a>
          ...
          <div class="col-6 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-3">
            <div class="service">
              <a href="walking_service_main.do" class="d-block"><img src="resources/images/notbed.png" alt="Image" class="img-fluid"></a>
              <div class="service-inner">
              </div>
            </div>
          </div>
          <div class="col-6 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-3">
            <div class="service">
              <a href="life_service_main.do" class="d-block"><img src="resources/images/happy.png" alt="Image" class="img-fluid"></a>
              <div class="service-inner">
              </div>
            </div>
          </div>
