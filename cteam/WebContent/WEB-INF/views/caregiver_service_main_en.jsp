          ...
          <div class="col-6 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-3">
            <div class="service">
              ...
              <div class="service-text">
                <h3>간병 도우미</h3>
                <p>간병인 선생님을 찾으시나요?<br>환자분과 간병인 선생님의 신뢰할 수 있는 좋은간병을 약속 드립니다. </p><hr>
            	<img src="resources/images/caregiver_explan.JPG" alt="Image" class="img-fluid">
              </div>
        </div>
      </div>
      	<div class="apply_button">
  	     	<p>
        		<a href="customer_service_apply_yj.do" class="btn btn-primary" id="apply_button">서비스 신청하기</a>               
    	    	<a href="guide_nursing_apply_yj.do" class="btn btn-primary" id="apply_button">간병인 지원하기</a>
	       	</p>               
	    </div>
	</div>
