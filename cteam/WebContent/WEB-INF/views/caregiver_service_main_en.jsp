      ...
      <div class="container">
        <div class="row">
      	...
      	<div class="apply_button">
  	     	<p>
        		<a href="ServiceWrite.do" class="btn btn-primary" id="apply_button">서비스 신청하기</a>               
    	    	<a href="apply_caregiver_detail_en.do" class="btn btn-primary" id="apply_button">간병인 지원하기</a>
	       	</p>               
	    </div>
	</div>
