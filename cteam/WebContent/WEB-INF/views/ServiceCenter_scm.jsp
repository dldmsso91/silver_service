      ...
      <div class="container">
        <div class="row">
          <div class="col-6 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-3">
			...
			고객님이 자주 찾는 질문에 대한 궁금증을 해결해드립니다.

			귀하께서 보내주신 의견과 질문을 적극 반영하겠습니다.

                </p>
            	<p><a href="apply_services_type.do" class="btn btn-primary">상담하러가기</a></p>               
            	<form>
				  <select name="language" >
				    <option value="none">=== 선택 ===</option>
				    <option value="korean">도시락지원</option>
				    <option value="english">대중교통지원</option>
				    <option value="chinese">음성인식</option>
				    <option value="spanish">도우미서비스</option>
