...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <div class="slide-item overlay" style="background-image: url('resources/images/elderly_people.jpg')">
      <div class="container">
      ...
      <div class="container">
        <div class="row">
          <div class="col-6 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-3">
            <div class="service">
              <a href="#" class="d-block"><img src="resources/images/sample.png" alt="Image" class="img-fluid" width="250" ></a>
              <div class="service-inner">
                <h3>터치 한 번으로</h3><br>
                <p>번거롭게 계속 터치하며 진행하는 방식에서 벗어나 터치 한 번으로 음성인식을 할 수 있게 하여 원하는 서비스를 좀 더 쉽게 접근할 수 있도록 하였습니다.</p>
              </div>
            </div>
          </div>
          <div class="col-6 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-3">
            <div class="service">
              <a href="#" class="d-block"><img src="resources/images/sample2.png" alt="Image" class="img-fluid" width="250"></a>
              <div class="service-inner">
                <h3>신속한 음성인식 처리</h3><br>
                <p>음성 인식을 최대한 빠르게 할 수 있도록 설계하였습니다.</p>
              </div>
            </div>
          </div>
          <div class="col-6 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-3">
            <div class="service">
              <a href="#" class="d-block"><img src="resources/images/sample3.png" alt="Image" class="img-fluid" width="250"></a>
              <div class="service-inner">
                <h3>원하는 모든 서비스를</h3><br>
                <p>음성 인식을 통해 저희가 제공하는 모든 서비스를 제공 받아 보실 수 있습니다.</p>
              </div>
            </div>
          </div>
          <div class="col-6 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-3">
            <div class="service">
              <a href="#" class="d-block"><img src="resources/images/sample4.png" alt="Image" class="img-fluid" width="250"></a>
              <div class="service-inner">
                <h3>한 번에 예약완료까지</h3><br>
                <p>목소리만으로 예약까지 가능하게 만들었습니다.
					순차적인 진행으로 쉽게 접근할 수 있습니다.
				</p>
              </div>
            </div>
          </div>
