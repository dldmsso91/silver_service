      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <div class="mb-0 site-logo"><a href="index.do" class="mb-0">노인정부지원<span class="text-primary">.</span> </a></div>
          </div>
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <button type="button">회원가입</button>	             
                ...
                <li class="has-children">
                  <a href="apply_services.do" class="nav-link">도우미서비스</a>
                  <ul class="dropdown">
                ...
                <li><a href="testimonial.do" class="nav-link">도시락지원</a></li>


                <li><a href="blog.do" class="nav-link">노인커뮤니티</a></li>
                <li><a href="about.do" class="nav-link">음성인식지원</a></li>
                <li><a href="contact.do" class="nav-link">노약자대중교통</a></li>
              </ul>
            </nav>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 align-self-center">
            <h1 class="heading mb-3">노인을 위한 서비스</h1>
            <p class="lead text-white mb-5">이제 여기에서 해결 하세요</p>
            <p><a href="board/list" class="btn btn-primary">공지사항</a></p>
            <p><a href="#" class="btn btn-primary">새소식</a></p>
            <p><a href="#" class="btn btn-primary">고객센터</a></p>
          </div>
        </div>
      </div>  
    </div>
