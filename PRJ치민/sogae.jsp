          ...
          <div class="col-6 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-3">
            <div class="service">
              ...
              <div class="service-text">
                <h3>노인정부지원소개</h3>
                <p>
                새로운 소식이 있어요! 새로운 정책도 있어요!
                우리 모두 웃어요^^ 행복하세요!
                </p>
            	<p><a href="apply_services_type.do" class="btn btn-primary">정책 정보</a></p>               
            	<p><a href="apply_services_type.do" class="btn btn-primary">불만사항</a></p> 
            	<p><a href="apply_services_type.do" class="btn btn-primary">공지사항</a></p>              
              </div>
        </div>
      </div>
    </div>
